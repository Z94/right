...
<body>
	<form name="form1" method="post" action="right">
		<input type="hidden" name="id" value="${manager.getManager_id() }">
		<input type="hidden" name="tableName" value="d_r_fun_manager">
		
		<input type="hidden" name="deleteName" value="manager_id">
		<table align="center">
		...
		<tr>
			...
			<tr>
				<td width="40%">当前管理员拥有功能</td>
				<td width="20%"></td>
				<td width="40%">当前用户拥有功能</td>
			</tr>
			<tr>
				<td width="40%">
