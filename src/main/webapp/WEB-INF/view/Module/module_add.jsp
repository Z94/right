...
<form name="form1" method="post" action="moduleAdd">
	  ...
	  <TBODY>  
		  <tr>
		    <TD width="90%" height=53 background="../../images/333.gif">
		      <div align="center"><b><h1>当前模块名：${module.getModule_name() } </h1></B></DIV></TD>
		    <TD width="10%" height=53 background="../../images/333.gif"><img border="0" src="../../images/xtgl.gif"> </TD>
		  </TR>
	  </TBODY>
 </TABLE>
<HR color="#D7EAF8" size="6" noshade>
<input type="hidden" name="up_module_id" value="${module.getModule_id() }" readonly size="50" maxlength="10">
  <table width="50%" border="1" align="center" height="40" cellpadding="0" cellspacing="0"  bordercolordark="#FFFFFF" bordercolorlight="#102884">
    ...
    <tr >
      ...
      <td width="83%" > 
        <input type="text" name="module_name" value="" size="50" maxlength="20">
        </td>
    </tr>
    <tr >
      <td width="17%"  nowrap bgcolor="#C4CAE1" >所属模块</td>
      <td width="83%"  > 
        <input type="text" name="" value="${module.getModule_name() }" readonly size="50" maxlength="10">
        </td>
    </tr>
    <tr >
      <td width="17%"  nowrap bgcolor="#C4CAE1" >顺序号</td>
      <td width="83%"  > 
        <input type="text" name="module_order" value="" size="50" maxlength="10">
        </td>
    </tr>   
    <tr >
      <td width="17%"  nowrap bgcolor="#C4CAE1" >模块链接</td>
      <td width="83%"  > 
        <input type="text" name="module_url" value="" size="50" maxlength="10">
        </td>
    </tr> 
    <tr >
      <td width="17%"  nowrap bgcolor="#C4CAE1" >模块权限</td>
      <td width="83%"  > 
        <input type="text" name="module_control" value="" size="50" maxlength="10">
        </td>
    </tr>  
  </table>
  <div align="center">
