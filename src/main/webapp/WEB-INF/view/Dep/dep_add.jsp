...
<form name="form1" id="form1" method="post" action="orgAdd" id="form1">
...
<input type="hidden" name="up_org_id" value="${org.getOrg_id() }" size="50" maxlength="20">
  <table width="50%" border="1" align="center" height="40" cellpadding="0" cellspacing="0"  bordercolordark="#FFFFFF" bordercolorlight="#102884">
    ...
    <tr >
      ...
      <td width="83%" > 
        <input type="text" name="org_name" value="" size="50" maxlength="20" class="required">
        </td>
    </tr>
    <tr >
      <td width="17%"  nowrap bgcolor="#C4CAE1" >顺序号</td>
      <td width="83%"  > 
        <input type="text" name="org_order" value="" size="50" maxlength="10"  class="required number">
        </td>
    </tr>    
  </table>
  <div align="center">
